...
ENTRIES = {
    'console_scripts' : [
        ...
        'phenix-app-mgmt_tap = phenix.apps.mgmt_tap.mgmt_tap:main',
        'phenix-app-carnac_internet = phenix.apps.carnac_internet.carnac_internet:main',
        'phenix-app-pst = phenix.apps.pst.pst:main',
